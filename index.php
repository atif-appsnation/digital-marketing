            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 mt-4 mt-xl-0 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="bg-white gp mt-4">
                            <h3>Google Ads</h3>
                            <p>Get instant traffic and maximize ROI.</p>                    
                        </div>
                        <div class="bg-white gp mt-4">
                            <h3>Video Content Creation</h3>
                            <p>Create videos that convert.</p>                    
                        </div>
                    </div>
                    <div class="col-xl-6 mt-3 mt-xl-0 wow fadeInUp" data-wow-delay=".5s">
                        <div class="bg-white gp">
                            <h3>Social Media Marketing</h3>
                            <p>Grow your brand and engage audiences.</p>                    
                        </div>
                        <div class="bg-white gp mt-4">
                            <h3>Mobile App Marketing</h3>
                            <p>Boost installs and user engagement.</p>                    
                        </div>
                        <div class="bg-white gp mt-4">
                            <h3>Lead Generation</h3>
                            <p>Drive quality leads efficiently.</p>                    
                        </div>
                    </div>
                </div>
                <div class="row">
					...
					<div class="scrollHalf__grupo__contenido col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 offset-xl-1 mt-auto mb-auto">
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>Average Cost per Conversion</th>
                                    <td>AED 8.24</td>
                                </tr>
                                <tr>
                                    <th>Total Spend</th>
                ...
                <div class="scrollHalf__grupo row h-100" data-scroll>
					...
					<div class="scrollHalf__grupo__contenido col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 offset-xl-1 mt-auto mb-auto">
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    <th>Total Messaging Conversions</th>
                                    <td>73+</td>
                                </tr>
                                <tr>
                                    <th>Total Reach</th>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="team-content">
                            <div class="section-title">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay=".3s">Let’s Grow Your Business with AI-Powered Marketing Let’s make something awesome together</h2>
                            </div>
